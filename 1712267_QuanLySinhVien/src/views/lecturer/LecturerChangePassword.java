...
public class LecturerChangePassword extends JDialog {
	...
	public static void main(String[] args) {
		try {
			LecturerChangePassword dialog = new LecturerChangePassword(new GiaoVu());
	...
	public LecturerChangePassword(GiaoVu giaoVu) {
		this.giaoVu = giaoVu;
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent arg0) {
						...
						GiaoVu foundGV = giaoVuDao.findById(LecturerChangePassword.this.giaoVu.get_gvNo());
						if (foundGV == null) {
