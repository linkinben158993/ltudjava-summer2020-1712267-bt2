...
(
	MA_DOT INT AUTO_INCREMENT,
	
    PHUCKHAO_NGAYMO TIMESTAMP,
    PHUCKHAO_NGAYDONG TIMESTAMP,

    CONSTRAINT PK_DOT PRIMARY KEY (MA_DOT)
);
...
BEGIN
	IF (
		(SELECT DOT.PHUCKHAO_NGAYMO FROM DOT WHERE DOT.MA_DOT = NEW.MA_DOT) > NEW.NGAY_NOP
        OR
        (SELECT DOT.PHUCKHAO_NGAYDONG FROM DOT WHERE DOT.MA_DOT = NEW.MA_DOT) < NEW.NGAY_NOP
        )
        THEN
			BEGIN
				SIGNAL SQLSTATE '45000'
				SET MESSAGE_TEXT = 'Error: Khong trong thoi gian phuc khao.';				
            END;
	END IF;
...
-- YÊU CẦU PHÚC KHẢO
-- Test trigger
INSERT INTO PHUC_KHAO VALUE (NULL, "1842003 ", "18HCB-CTT001", 3, 11, "Thầy/Cô xem giúp em điểm cuối kì.", '2020-06-10 23:59:00', NULL, 1);
INSERT INTO PHUC_KHAO VALUE (NULL, "1842003 ", "18HCB-CTT001", 3, 11, "Thầy/Cô xem giúp em điểm cuối kì.", '2020-06-11 23:59:00', NULL, 1);
INSERT INTO PHUC_KHAO VALUE (NULL, "1842003 ", "18HCB-CTT001", 4, 9, "Thầy/Cô xem giúp em điểm cuối kì.", '2020-06-11 23:59:00', NULL, 1);

-- MO DOT PHUC KHAO
INSERT INTO DOT VALUE (NULL, CURRENT_TIMESTAMP(), DATE_ADD(CURRENT_TIMESTAMP(), INTERVAL 10 DAY));
